...
# 多个编译源文件目录
CPP_SRC_DIR=../../../network/pipe/client
...
# 输出中间文件目录
DEBUG_OUT_DIR=../../../../../../BCSrcOut/sample/cos-x86-64/network/pipe/client/debug
RELEASE_OUT_DIR=../../../../../../BCSrcOut/sample/cos-x86-64/network/pipe/client/release
...
# 输出静态库
DEBUG_EXE_FILE=$(OUT_TARGET_DIR)/pipeClient_d.out
RELEASE_EXE_FILE=$(OUT_TARGET_DIR)/pipeClient.out
