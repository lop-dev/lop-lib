...
namespace CSLib.UltraKit.DemoPlugin
{
    public partial class DemoUserControl : UserControl, IUCMenu
    {
        ...
        private DemoPlugin01 m_DemoPlugin;
        ...
        {
            MessageBox.Show("Hello DemoPlugin01");
        }


        private void button2_Click(object sender, EventArgs e)
        {
            DemoCommand cmd = new DemoCommand("Demo01UnExecCmd");
        ...
        {
            DemoCommand cmd = new DemoCommand("Demo01ExecCmd");
            cmd.SetDemoModuleCore(m_DemoPlugin);
            cmd.Execute();
