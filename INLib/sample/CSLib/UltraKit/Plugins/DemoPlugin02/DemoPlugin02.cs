...
{
    public class DemoPlugin02 : IPlugIn, IEvent
    {
        ...
        {
            EventManager.Instance.RegisterEvent("ULTRAKIT_PLUGIN_EVENT_TEST_02", m_pluginId, new OnUltraKitEvent(Plugin01Event));
        }

        public void UnRegistEvents()
        {
            EventManager.Instance.UnRegisterEvent("ULTRAKIT_PLUGIN_EVENT_TEST_02", m_pluginId);
        }
