...
/// link with Imm32.lib, Version.lib
#ifndef UNICODE
	#define UNICODE
#endif
...
bool	ImeUi_IsReadingError();
void    ImeUi_SetCompositionWindowPosition(int x, int y);
void    ImeUi_SetCandidateWindowPosition(int x, int y);
void    ImeUi_EnableUiLessMode(bool enable);
