...
enum EMsgIDGameFrame
{
    ...
    EMID_MS2XS_REQ_CLOSE_SERVER,
    EMID_XS2MS_ACK_CLOSE_SERVER,
    EMID_MS2XS_NTF_CLOSE_SERVER,
...
SFLIB_MSGDEBUG(ESERVER_ANYXS, EFUNC_GAMEFRAME, EMID_MS2XS_REQ_CLOSE_SERVER);
struct SMsgMS2XSReqCloseServer : public SNetMessage
{
public:
    SMsgMS2XSReqCloseServer() : SNetMessage(ESERVER_ANYXS, EFUNC_GAMEFRAME, EMID_MS2XS_REQ_CLOSE_SERVER)
    {
    }
};

SFLIB_MSGDEBUG(ESERVER_MASTER, EFUNC_GAMEFRAME, EMID_XS2MS_ACK_CLOSE_SERVER);
struct SMsgXS2MSAckCloseServer : public SNetMessage
{
public:
    SMsgXS2MSAckCloseServer() : SNetMessage(ESERVER_MASTER, EFUNC_GAMEFRAME, EMID_XS2MS_ACK_CLOSE_SERVER)
    {
        m_serverID = INVALID_SERVER_ID;
        m_result = 0;
    }
...
SFLIB_MSGDEBUG(ESERVER_ANYXS, EFUNC_GAMEFRAME, EMID_MS2XS_NTF_CLOSE_SERVER);
struct SMsgMS2XSNtfCloseServer : public SNetMessage
{
public:
    SMsgMS2XSNtfCloseServer() : SNetMessage(ESERVER_ANYXS, EFUNC_GAMEFRAME, EMID_MS2XS_NTF_CLOSE_SERVER)
    {
    }
};
