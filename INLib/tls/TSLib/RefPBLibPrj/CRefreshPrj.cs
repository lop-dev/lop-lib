...
namespace RefreshPTPrj
{
    class CRefreshPrj
    {
        ...
        static string vcxprojPath = currentDirectory + "/prj/PBLib/vs15/PBLib.vcxproj";
        static string vcxprojFilterPath = currentDirectory + "/prj/PBLib/vs15/PBLib.vcxproj.filters";
