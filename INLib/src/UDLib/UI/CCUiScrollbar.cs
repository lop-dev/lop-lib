...
namespace UDLib.UI
{
    [AddComponentMenu("UI/CCUiScrollbar", 203)]
    [RequireComponent(typeof(RectTransform))]
    public class CCUiScrollbar : Selectable, IBeginDragHandler, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
    {
        ...
        public int numberOfSteps { get { return m_NumberOfSteps; } set { { Set(m_Value); UpdateVisuals(); } } }
