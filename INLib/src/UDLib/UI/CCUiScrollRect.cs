...
namespace UDLib.UI
{
    [AddComponentMenu("UI/CCUiScroll Rect", 202)]
    [SelectionBase]
    [ExecuteInEditMode]
    [DisallowMultipleComponent]
    [RequireComponent(typeof(RectTransform))]
    public class CCUiScrollRect : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        ...
        [SerializeField]
        private CCUiScrollbar m_HorizontalScrollbar;
        public CCUiScrollbar horizontalScrollbar
        {
            get
            {
        ...
        [SerializeField]
        private CCUiScrollbar m_VerticalScrollbar;
        public CCUiScrollbar verticalScrollbar
        {
            get
            {
        ...
        protected virtual void LateUpdate()
        {
            ...
            if (m_ViewBounds != m_PrevViewBounds || m_ContentBounds != m_PrevContentBounds || m_Content.anchoredPosition != m_PrevPosition)
            {
                ...
                UISystemProfilerApi.AddMarker("CUiScrollRect.value", this);
        ...
        private static void UpdateOneScrollbarVisibility(bool xScrollingNeeded, bool xAxisEnabled, ScrollbarVisibility scrollbarVisibility, CCUiScrollbar scrollbar)
        {
            if (scrollbar)
            {
