...
# 输出中间文件目录
DEBUG_OUT_DIR=../../../../../MWSrcOut/cos-x86-64/misc/debug
RELEASE_OUT_DIR=../../../../../MWSrcOut/cos-x86-64/misc/release
...
# 输出静态库
DEBUG_LIB_FILE=$(OUT_TARGET_DIR)/libMisc_d.a
RELEASE_LIB_FILE=$(OUT_TARGET_DIR)/libMisc.a
...
# 输出动态库
DEBUG_DLL_FILE=$(OUT_TARGET_DIR)/libMisc_d.so
RELEASE_DLL_FILE=$(OUT_TARGET_DIR)/libMisc.so
