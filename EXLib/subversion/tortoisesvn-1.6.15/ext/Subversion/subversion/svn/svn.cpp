      ...
      if ((second_colon = strchr(first_colon + 1, ':')) && (second_colon != first_colon + 1))
        {
          if ((equals_sign = strchr(second_colon + 1, '=')) && (equals_sign != second_colon + 1))
            {
              config_option = (config_option_t *)apr_pcalloc(pool, sizeof(config_option_t));
...
namespace Subversion
{
	...
	int
	CSvn::exe(int argc, const char *argv[])
	{
	  svn_error_t *err;
	  ...
	  opt_state.revision_ranges = NULL;
	  opt_state.start_revision.kind = svn_opt_revision_unspecified;
	  opt_state.start_revision.value.date = 0;
	  opt_state.start_revision.value.number = 0;
	  opt_state.end_revision.kind = svn_opt_revision_unspecified;
	  opt_state.end_revision.value.date = 0;
	  ...
	  opt_state.message = NULL;
	  opt_state.ancestor_path = NULL;
	  opt_state.force = 0;
	  ...
	  opt_state.update = 0;    
	  opt_state.strict = 0;
	  opt_state.filedata = NULL;
	  opt_state.encoding = NULL;
	  opt_state.help = 0;   
	  opt_state.auth_username = NULL;
	  opt_state.auth_password = NULL;
	  opt_state.extensions = NULL; 
	  opt_state.targets = NULL;   
	  opt_state.xml = 0;
	  ...
	  cfg_config = (svn_config_t *)apr_hash_get(ctx->config, SVN_CONFIG_CATEGORY_CONFIG,
								APR_HASH_KEY_STRING);
	  cfg_servers = (svn_config_t *)apr_hash_get(ctx->config, SVN_CONFIG_CATEGORY_SERVERS,
								 APR_HASH_KEY_STRING);
	  ...
	  if ((opt_state.accept_which == svn_cl__accept_unspecified
		...
		{
		  svn_cmdline_prompt_baton_t *pb = (svn_cmdline_prompt_baton_t *)apr_palloc(pool, sizeof(*pb));
